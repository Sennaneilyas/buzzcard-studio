    ...
    <LazyMotion features={domAnimation}>
      <div className={`relative w-full ${className || ""}`}>
        ...
        <div className="hidden lg:flex items-center justify-center gap-12 xl:gap-24 relative max-w-[1400px] mx-auto pt-4 pb-20 px-10">
          ...
          {/* SVG connector layer stays below the navbar so section graphics never sit above the top nav */}
          {data.length > 1 && (
            <div
              className="absolute top-1/2 left-1/2 w-[280px] xl:w-[320px] aspect-square pointer-events-none z-40 hidden lg:block"
