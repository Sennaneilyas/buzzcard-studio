...
import { Wifi, Phone, Mail, Globe, Briefcase, Camera, ExternalLink, MapPin, Share2 } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 rounded-2xl" style={{ background: "linear-gradient(135deg, rgba(255,255,255,0.12) 0%, transparent 40%)" }} />
              <motion.div
                className="absolute inset-0 rounded-2xl"
                style={{ background: "linear-gradient(105deg, transparent 35%, rgba(255,255,255,0.2) 42%, rgba(255,255,255,0.08) 48%, transparent 55%)", backgroundSize: "200% 100%" }}
              ...
              <div className="absolute inset-0 p-3 sm:p-4 lg:p-5 flex flex-col justify-between z-10">
                <div className="flex justify-between items-start">
                  ...
                  <img src="/logoHB.svg" alt="Logo" className="h-2.5 sm:h-3 invert opacity-40" />
                </div>
                <div>
                  <div className="w-7 h-7 sm:w-8 sm:h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-br from-mint/20 to-mint/5 border border-mint/20 mb-2 flex items-center justify-center">
                    <span className="text-xs sm:text-sm lg:text-base font-bold text-mint">A</span>
                  </div>
                  <p className="text-white font-bold text-xs sm:text-sm lg:text-base tracking-wide">Alex Designer</p>
                  <p className="text-white/50 text-[8px] sm:text-[10px] lg:text-xs font-medium">Creative Director</p>
                </div>
              </div>
            ...
            >
              ...
              <div className="absolute bottom-3 sm:bottom-4 right-3 sm:right-4 text-[7px] sm:text-[8px] lg:text-[9px] text-white/20 tracking-[0.2em] font-mono uppercase">BuzzCard</div>
        ...
        <div className="absolute left-1/2 top-[30%] -translate-x-1/2 z-[2] hidden sm:flex items-center justify-center pointer-events-none">
          <div ref={ripple1Ref} className="absolute rounded-full border border-navy/[0.08] will-change-transform" style={{ width: 140, height: 140 }} />
          <div ref={ripple2Ref} className="absolute rounded-full border border-navy/[0.08] will-change-transform" style={{ width: 140, height: 140 }} />
          <div ref={ripple3Ref} className="absolute rounded-full border border-navy/[0.08] will-change-transform" style={{ width: 140, height: 140 }} />
        </div>
          ...
          <div className="relative bg-[#1a1a1a] rounded-[2.8rem] sm:rounded-[3rem] border-[5px] sm:border-[6px] border-[#2a2a2a] shadow-[0_30px_80px_rgba(0,0,0,0.25),0_10px_30px_rgba(0,0,0,0.15),inset_0_1px_0_rgba(255,255,255,0.05)] overflow-hidden">
            ...
            <div className="relative bg-white overflow-hidden">
              ...
              <div className="flex items-end justify-between px-7 sm:px-8 pt-3 pb-1 z-20 relative">
                <span className="text-[10px] font-semibold text-ink/70">9:41</span>
                <div className="flex items-center gap-1">
                  <span className="text-[9px] font-semibold text-ink/50">5G</span>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex-1 text-left min-w-0">
                  <p className="text-[11px] sm:text-xs font-bold text-ink leading-tight">BuzzCard Studio</p>
                  <p className="text-[9px] sm:text-[10px] text-ink/50 font-medium mt-0.5 truncate">Alex shared their profile with you</p>
                </div>
                <span className="text-[8px] sm:text-[9px] text-ink/30 font-medium shrink-0">now</span>
              </div>
              ...
              <div className="px-5 sm:px-6 pt-6 pb-8 sm:pb-10 space-y-4">
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-ink">Alex Designer</h3>
                  <p className="text-xs sm:text-sm text-ink/50 font-medium">Creative Director</p>
                  <div className="flex items-center gap-1 mt-1 text-ink/40">
                    <MapPin className="w-3 h-3" />
                    <span className="text-[10px] sm:text-xs">San Francisco, CA</span>
                  </div>
                </div>
                ...
                <div className="flex gap-2.5 justify-center pt-2">
                  {[
                    { icon: Phone, label: "Call", color: "bg-mint/10 text-mint" },
                    { icon: Mail, label: "Email", color: "bg-navy/10 text-navy" },
                    { icon: Share2, label: "Share", color: "bg-ink/[0.06] text-ink/60" },
                  ].map((action) => (
                    <div
                      key={action.label}
                    ...
                    >
                      ...
                      <span className="text-[9px] sm:text-[10px] font-semibold">{action.label}</span>
                    </div>
                  ))}
                </div>
                ...
                <div className="bg-cloud/80 rounded-2xl p-3.5 sm:p-4 space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[9px] sm:text-[10px] text-ink/40 font-medium">Phone</p>
                      <p className="text-xs sm:text-sm font-semibold text-ink truncate">+1 (415) 555-0132</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[9px] sm:text-[10px] text-ink/40 font-medium">Email</p>
                      <p className="text-xs sm:text-sm font-semibold text-ink truncate">alex@designstudio.co</p>
                    </div>
                  </div>
                  <div className="h-px bg-ink/[0.06]" />
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[9px] sm:text-[10px] text-ink/40 font-medium">Website</p>
                      <p className="text-xs sm:text-sm font-semibold text-ink truncate">alexdesigner.com</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <p className="text-[10px] sm:text-xs font-semibold text-ink/40 uppercase tracking-wider">Socials</p>
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      { icon: Briefcase, label: "LinkedIn", handle: "@alexdesigner", bg: "bg-[#0A66C2]/10 text-[#0A66C2]" },
                      { icon: Camera, label: "Instagram", handle: "@alex.design", bg: "bg-[#E4405F]/10 text-[#E4405F]" },
                    ].map((social) => (
                      <div key={social.label} className={`flex items-center gap-2 px-3 py-2.5 rounded-xl ${social.bg}`}>
                        <social.icon className="w-4 h-4 shrink-0" />
                        <div className="min-w-0">
                          <p className="text-[10px] sm:text-xs font-semibold truncate">{social.label}</p>
                          <p className="text-[8px] sm:text-[9px] opacity-60 truncate">{social.handle}</p>
                        </div>
                      </div>
                    ))}
                  </div>
