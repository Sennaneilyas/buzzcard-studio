...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setTapped(false);
      tapTimeout = setTimeout(() => setTapped(true), 1500);
    }, 4500);

    const initialTimeout = setTimeout(() => setTapped(true), 1000);
  ...
  return (
    <section
      className="relative isolate min-h-screen flex items-center justify-center overflow-hidden pt-28 lg:pt-20 pb-16"
      id="hero"
    >
      <HeroBackground />
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 lg:gap-12 items-center z-10 max-w-7xl">
        ...
        <div className="text-left w-full max-w-2xl mx-auto lg:mx-0">
          ...
          >
            <a
              href="#pricing"
              className="group inline-flex items-center justify-center gap-2 px-8 py-4 text-base font-semibold text-ink bg-mint rounded-2xl transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,230,118,0.35)] hover:scale-[1.02] active:scale-[0.98]"
            >
              Get Your Card
            ...
            <a
              href="#how-it-works"
              className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-navy border-2 border-navy/15 rounded-2xl transition-all duration-300 hover:border-navy/30 hover:bg-navy/5 bg-white/50 backdrop-blur-sm"
            >
              See How It Works
            </a>
          </motion.div>
            ...
            <div className="flex-1 bg-surface relative w-full flex flex-col items-center pt-10 sm:pt-12 overflow-hidden">
              ...
              >
                ...
                <div className="flex-1 text-left">
                  ...
                  <p className="text-[10px] sm:text-[11px] text-ink/60 font-medium mt-0.5">
                    Alex shared their profile
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-semibold text-navy/70">
                  Ready to scan
                </span>
              </motion.div>
            </div>
              ...
              >
                ...
                <div className="relative z-10 flex justify-between items-start">
                  ...
                  <img
                    src="/logoHB.svg"
                    alt=""
                    className="h-3 sm:h-4 invert opacity-50"
                  />
                </div>
                ...
                <div className="relative z-10">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-full bg-mint/10 border border-mint/20 mb-2 sm:mb-3 lg:mb-4 flex items-center justify-center">
                    <span className="text-base sm:text-lg lg:text-xl font-bold text-mint">
                      A
                    </span>
                  </div>
