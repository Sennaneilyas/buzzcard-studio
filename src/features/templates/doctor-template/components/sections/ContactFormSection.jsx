...
export function ContactFormSection() {
  ...
  return (
    ...
    >
      ...
      <motion.form variants={fadeInUp} onSubmit={handleSubmit} className="mt-8 flex flex-col gap-3.5 p-6 bg-[#F8FAFC] rounded-[20px] border-[0.67px] border-[var(--primary-color,#4682b4)2e] w-full">
