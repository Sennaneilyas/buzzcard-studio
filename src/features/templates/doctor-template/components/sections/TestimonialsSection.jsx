      ...
      <div className="mt-8 flex flex-col gap-4">
        {testimonials.map((t, idx) => (
          <motion.div key={idx} variants={fadeInUp} className="bg-white p-6 rounded-[24px] border-[0.667px] border-[rgba(70,130,180,0.18)] drop-shadow-[0px_2px_7px_rgba(70,130,180,0.1)]">
            ...
            <p className="text-[var(--primary-color,#4682b4)] text-[13px] italic mb-6 leading-relaxed">
              {t.text}
            </p>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-[var(--primary-color,#4682b4)] text-[14px]">{t.author}</p>
